...
class ChitietBantinDangSanXuatController extends GetxController
  ...
  void loadChiTietBanTinDangSanXuat() async {
  ...
  void xuLyChucNang(chucNang) async {
    ...
    try {
      ...
      if (value['isSuccess'] == true) {
        ...
        this.loadChiTietBanTinDangSanXuat();
      } else {

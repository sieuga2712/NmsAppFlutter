...
class ChitietBantinKhongDuyetVideoController extends GetxController
  ...
  void loadChiTietBanTinKhongDuyetVideo() async {
  ...
  void xuLyChucNang(chucNang) async {
    ...
    try {
      ...
      if (value['isSuccess'] == true) {
        ...
        this.loadChiTietBanTinKhongDuyetVideo();
      } else {
  ...
  void onInit() {
    super.onInit();
    loadChiTietBanTinKhongDuyetVideo();

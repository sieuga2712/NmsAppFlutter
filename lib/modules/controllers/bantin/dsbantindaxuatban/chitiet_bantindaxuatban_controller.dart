...
class ChitietBantinDaXuatBanController extends GetxController
  ...
  void loadChiTietBanTinDaXuatBan() async {
  ...
  void xuLyChucNang(chucNang) async {
    ...
    try {
      ...
      if (value['isSuccess'] == true) {
        ...
        this.loadChiTietBanTinDaXuatBan();
      } else {

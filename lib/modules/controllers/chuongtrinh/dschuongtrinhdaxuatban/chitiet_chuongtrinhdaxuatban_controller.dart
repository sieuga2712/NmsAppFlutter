...
class ChitietChuongtrinhDaXuatBanController extends GetxController
  ...
  void loadChiTietChuongTrinhDaXuatBan() async {
    change(null, status: RxStatus.loading());
    print('chuongTrinhId loadChiTietChuongTrinhDaXuatBan: $chuongTrinhId');
    try {
  ...
  void xuLyChucNang(chucNang) async {
    ...
    try {
      ...
      if (value['isSuccess'] == true) {
        ...
        this.loadChiTietChuongTrinhDaXuatBan();
      } else {
  ...
  void onInit() {
    super.onInit();
    loadChiTietChuongTrinhDaXuatBan();
  }

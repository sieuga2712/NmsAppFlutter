...
class ChitietChuongtrinhKhongduyetKBController extends GetxController
  ...
  void loadChiTietChuongTrinhKhongDuyetKB() async {
    change(null, status: RxStatus.loading());
    print('chuongTrinhId loadChiTietChuongTrinhKhongDuyetKB: $chuongTrinhId');
    try {

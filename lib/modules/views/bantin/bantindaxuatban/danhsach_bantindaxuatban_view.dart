...
class DanhsachBantinDaxuatbanView
    extends GetView<DanhsachBantinDaxuatbanController> {
  const DanhsachBantinDaxuatbanView({super.key});

  Future<void> _onRefresh() async {
    controller.clearSearch();
    controller.loadDanhSachBantinDaxxuatban();
              ...
              (filteredDsBanTinDaXB) =>
                ...
                child: RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: filteredDsBanTinDaXB!.length + 1,
                    itemBuilder: (context, index) {
                      if (index == filteredDsBanTinDaXB.length) {
                      ...
                      var banTin = filteredDsBanTinDaXB[index];
                      final statusInfo =

...
class ChitietBantinDangsanxuatView extends StatefulWidget {
  const ChitietBantinDangsanxuatView({super.key});

  @override
  _ChitietBantinDangsanxuatViewState createState() =>
      _ChitietBantinDangsanxuatViewState();
}

class _ChitietBantinDangsanxuatViewState
    extends State<ChitietBantinDangsanxuatView> {
  final ChitietBantinDangSanXuatController controller = Get.find();

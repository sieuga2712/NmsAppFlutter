...
class ChitietBantinKhongduyetvideoView extends StatefulWidget {
  const ChitietBantinKhongduyetvideoView({super.key});

  @override
  _ChitietBantinKhongduyetvideoViewState createState() =>
      _ChitietBantinKhongduyetvideoViewState();
}

class _ChitietBantinKhongduyetvideoViewState
    extends State<ChitietBantinKhongduyetvideoView> {
  final ChitietBantinKhongDuyetVideoController controller = Get.find();

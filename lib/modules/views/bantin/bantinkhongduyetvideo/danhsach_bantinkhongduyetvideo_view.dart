...
class DanhsachBantinKhongduyetvideoView
    extends GetView<DanhsachBantinKhongduyetvideoController> {
  const DanhsachBantinKhongduyetvideoView({super.key});

  Future<void> _onRefresh() async {
    controller.clearSearch();
    controller.loadDanhSachBantinKhongduyetvideo();

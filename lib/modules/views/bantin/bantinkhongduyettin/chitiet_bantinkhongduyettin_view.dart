...
class ChitietBantinKhongduyettinView extends StatefulWidget {
  const ChitietBantinKhongduyettinView({super.key});

  @override
  _ChitietBantinKhongduyettinViewState createState() =>
      _ChitietBantinKhongduyettinViewState();
}

class _ChitietBantinKhongduyettinViewState
    extends State<ChitietBantinKhongduyettinView> {
  final ChitietBantinKhongDuyetTinController controller = Get.find();

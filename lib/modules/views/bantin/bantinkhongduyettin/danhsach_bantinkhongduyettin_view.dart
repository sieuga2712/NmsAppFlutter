...
class DanhsachBantinKhongduyettinView
    extends GetView<DanhsachBantinKhongduyettinController> {
  const DanhsachBantinKhongduyettinView({super.key});

  Future<void> _onRefresh() async {
    controller.clearSearch();
    controller.loadDanhSachBantinKhongduyettin();
              ...
              (filteredDsBanTinKhongDuyetTin) =>
                ...
                child: RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: filteredDsBanTinKhongDuyetTin!.length + 1,
                    itemBuilder: (context, index) {
                      if (index == filteredDsBanTinKhongDuyetTin.length) {
                      ...
                      var banTin = filteredDsBanTinKhongDuyetTin[index];
                      final statusInfo =

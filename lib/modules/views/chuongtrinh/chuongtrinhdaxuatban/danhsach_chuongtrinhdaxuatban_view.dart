...
class DanhsachChuongtrinhDaxuatbanView
  ...
  Future<void> _onRefresh() async {
    ...
    controller.loadDanhSachChuongTrinhDaXuatBan();
        ...
        children: [
          ...
          Expanded(
            child: controller.obx(
              (filteredDsChuongTrinhDaXuatBan) =>
                ...
                child: RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: filteredDsChuongTrinhDaXuatBan!.length + 1,
                    itemBuilder: (context, index) {
                      if (index == filteredDsChuongTrinhDaXuatBan.length) {
                      ...
                      var chuongTrinh = filteredDsChuongTrinhDaXuatBan[index];
